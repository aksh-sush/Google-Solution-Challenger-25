...
class ClockFaceView extends e implements ClockHandView.b {
    ...
    class b extends androidx.core.view.a {
        ...
        public void g(View view, h0 h0Var) {
            ...
            if (intValue > 0) {
                h0Var.A0((View) ClockFaceView.this.J.get(intValue - 1));
            }
    ...
    private void S(int i10) {
        ...
        for (int i11 = 0; i11 < Math.max(this.R.length, size); i11++) {
            ...
            if (i11 >= this.R.length) {
                ...
                textView.setTag(e.material_value_index, Integer.valueOf(i11));
                int i12 = (i11 / 12) + 1;
                textView.setTag(e.material_clock_level, Integer.valueOf(i12));
                if (i12 > 1) {
                    z10 = true;
                }
                androidx.core.view.h0.s0(textView, this.K);
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        h0.D0(accessibilityNodeInfo).d0(h0.b.a(1, this.R.length, false, 1));
    }
    ...
    public ClockFaceView(Context context, AttributeSet attributeSet, int i10) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, j.T0, i10, i.Widget_MaterialComponents_TimePicker_Clock);
        Resources resources = getResources();
        ColorStateList a10 = c.a(context, obtainStyledAttributes, j.V0);
        this.T = a10;
        ...
        this.N = resources.getDimensionPixelSize(o4.c.material_clock_hand_padding);
        ...
        int defaultColor = g.a.a(context, o4.b.material_timepicker_clockface).getDefaultColor();
        ColorStateList a11 = c.a(context, obtainStyledAttributes, j.U0);
        ...
        Arrays.fill(strArr, "");
        R(strArr, 0);
        this.O = resources.getDimensionPixelSize(o4.c.material_time_picker_minimum_screen_height);
        this.P = resources.getDimensionPixelSize(o4.c.material_time_picker_minimum_screen_width);
        this.Q = resources.getDimensionPixelSize(o4.c.material_clock_size);
    }
}
