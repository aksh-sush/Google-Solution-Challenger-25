...
final class zzaao extends zzyf<Long> implements RandomAccess, zzabg {
    ...
    public final int hashCode() {
        ...
        for (int i11 = 0; i11 < this.zzc; i11++) {
            i10 = (i10 * 31) + zzaac.zzc(this.zzb[i11]);
        }
        return i10;
    }
    ...
    public final /* bridge */ /* synthetic */ zzaab zzd(int i10) {
        if (i10 >= this.zzc) {
            return new zzaao(Arrays.copyOf(this.zzb, i10), this.zzc);
        }
    ...
    private zzaao(long[] jArr, int i10) {
        this.zzb = jArr;
        this.zzc = i10;
    }
