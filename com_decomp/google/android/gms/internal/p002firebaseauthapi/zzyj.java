...
final class zzyj extends zzyf<Boolean> implements RandomAccess, zzabg {
    ...
    public final int hashCode() {
        ...
        for (int i11 = 0; i11 < this.zzc; i11++) {
            i10 = (i10 * 31) + zzaac.zza(this.zzb[i11]);
        }
        return i10;
    }
    ...
    public final /* bridge */ /* synthetic */ zzaab zzd(int i10) {
        if (i10 >= this.zzc) {
            return new zzyj(Arrays.copyOf(this.zzb, i10), this.zzc);
        }
    ...
    private zzyj(boolean[] zArr, int i10) {
        this.zzb = zArr;
        this.zzc = i10;
    }
