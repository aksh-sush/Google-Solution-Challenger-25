...
public final class zzaw {
    ...
    static final zzaw zza(zzir zzir) {
        zzf(zzir);
        return new zzaw(zzir);
    }

    public static void zzf(zzir zzir) {
        if (zzir == null || zzir.zza() <= 0) {
            throw new GeneralSecurityException("empty keyset");
        }
    }

    public static final zzaw zzi(zzdy zzdy, zzag zzag) {
        zzho zza2 = zzdy.zza();
    ...
    public final <P> P zze(Class<P> cls) {
    ...
    public final void zzg(zzay zzay, zzag zzag) {
        zzir zzir = this.zza;
    ...
    public final void zzh(com.google.android.gms.internal.p002firebaseauthapi.zzay r5) {
        /*
            r4 = this;
