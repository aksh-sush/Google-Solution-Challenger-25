...
final class zzjd extends zzjg {
    ...
    public final void zze(int i10, zziy zziy) {
        zzq((i10 << 3) | 2);
        zzq(zziy.zzd());
        zziy.zzh(this);
    }
    ...
    public final void zzn(String str) {
        ...
        try {
            ...
            if (zzA2 == zzA) {
                int i11 = i10 + zzA2;
                this.zzd = i11;
                int zzb2 = zzmx.zzb(str, this.zzb, i11, this.zzc - i11);
                this.zzd = i10;
                zzq((zzb2 - i10) - zzA2);
                this.zzd = zzb2;
                return;
    ...
    public final void zzs(long j10) {
        if (!zzjg.zzc || this.zzc - this.zzd < 10) {
            ...
            while ((j10 & -128) != 0) {
                ...
                int i12 = this.zzd;
                this.zzd = i12 + 1;
                zzms.zzn(bArr3, (long) i12, (byte) ((((int) j10) & 127) | 128));
                j10 >>>= 7;
            }
            byte[] bArr4 = this.zzb;
            int i13 = this.zzd;
            this.zzd = i13 + 1;
            zzms.zzn(bArr4, (long) i13, (byte) ((int) j10));
        }
    }
}
