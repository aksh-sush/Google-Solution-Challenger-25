...
public class FirebaseInstallationServiceClient {
    ...
    static long parseTokenExpirationTimestamp(String str) {
        s.b(EXPIRATION_TIMESTAMP_PATTERN.matcher(str).matches(), PARSING_EXPIRATION_TIME_ERROR_MESSAGE);
        ...
        if (this.requestLimiter.b()) {
            ...
            while (i10 <= 1) {
                ...
                try {
                    ...
                    int responseCode2 = openHttpURLConnection.getResponseCode();
                    this.requestLimiter.f(responseCode2);
                    if (isSuccessfulResponseCode(responseCode2)) {
                        ...
                        if (responseCode2 == 401) {
                            ...
                            throw new FirebaseInstallationsException("Firebase servers have received too many requests from this client in a short period of time. Please try again later.", FirebaseInstallationsException.Status.TOO_MANY_REQUESTS);
                        } else if (responseCode2 < 500 || responseCode2 >= 600) {
                            logBadConfigError();
                        ...
                        readGenerateAuthTokenResponse = responseCode.build();
                    }
                    openHttpURLConnection.disconnect();
                    TrafficStats.clearThreadStatsTag();
