...
public final class ComponentDiscovery<T> {
    ...
    private static class b implements c {
        ...
        private Bundle b(Context context) {
            try {
                ...
                ServiceInfo serviceInfo = packageManager.getServiceInfo(new ComponentName(context, this.f7746a), 128);
                if (serviceInfo != null) {
                    return serviceInfo.metaData;
                }
                Log.w(ComponentDiscovery.TAG, this.f7746a + " has no service info.");
                return null;
    ...
    public List<Provider<ComponentRegistrar>> discoverLazy() {
        ArrayList arrayList = new ArrayList();
        for (String eVar : this.retriever.a(this.context)) {
