...
public class ArraySortedMap<K, V> extends ImmutableSortedMap<K, V> {
    ...
    class a implements Iterator {
        ...
        public Map.Entry next() {
            Object obj = ArraySortedMap.this.keys[this.f7786e];
            Object[] access$100 = ArraySortedMap.this.values;
            int i10 = this.f7786e;
            Object obj2 = access$100[i10];
            this.f7786e = this.f7788g ? i10 - 1 : i10 + 1;
        ...
        public boolean hasNext() {
            ...
            } else if (this.f7786e < ArraySortedMap.this.keys.length) {
                return true;
            }
            return false;
        }
    ...
    public Iterator<Map.Entry<K, V>> reverseIteratorFrom(K k10) {
        int findKeyOrInsertPosition = findKeyOrInsertPosition(k10);
        K[] kArr = this.keys;
        return (findKeyOrInsertPosition >= kArr.length || this.comparator.compare(kArr[findKeyOrInsertPosition], k10) != 0) ? iterator(findKeyOrInsertPosition - 1, true) : iterator(findKeyOrInsertPosition, true);
    }
