...
class h {
    ...
    private final CheckedTextView f1170a;

    /* renamed from: b, reason: collision with root package name */
    private ColorStateList f1171b = null;

    /* renamed from: c, reason: collision with root package name */
    private PorterDuff.Mode f1172c = null;
    ...
    h(CheckedTextView checkedTextView) {
        this.f1170a = checkedTextView;
    }

    void a() {
        Drawable a10 = androidx.core.widget.b.a(this.f1170a);
        if (a10 != null) {
            if (this.f1173d || this.f1174e) {
                Drawable mutate = androidx.core.graphics.drawable.a.r(a10).mutate();
                if (this.f1173d) {
                    androidx.core.graphics.drawable.a.o(mutate, this.f1171b);
                }
                if (this.f1174e) {
                    androidx.core.graphics.drawable.a.p(mutate, this.f1172c);
                }
                if (mutate.isStateful()) {
                    mutate.setState(this.f1170a.getDrawableState());
                }
                this.f1170a.setCheckMarkDrawable(mutate);
            }
        }
    }
    ...
    */
    void d(android.util.AttributeSet r10, int r11) {
        /*
            ...
            int r10 = f.j.R0     // Catch: java.lang.Throwable -> L85
            boolean r11 = r0.s(r10)     // Catch: java.lang.Throwable -> L85
            if (r11 == 0) goto L3b
            int r10 = r0.n(r10, r8)     // Catch: java.lang.Throwable -> L85
            if (r10 == 0) goto L3b
            android.widget.CheckedTextView r11 = r9.f1170a     // Catch: android.content.res.Resources.NotFoundException -> L3a java.lang.Throwable -> L85
        ...
        L3c:
            if (r10 != 0) goto L59
            int r10 = f.j.Q0     // Catch: java.lang.Throwable -> L85
            boolean r11 = r0.s(r10)     // Catch: java.lang.Throwable -> L85
            if (r11 == 0) goto L59
            int r10 = r0.n(r10, r8)     // Catch: java.lang.Throwable -> L85
            if (r10 == 0) goto L59
            android.widget.CheckedTextView r11 = r9.f1170a     // Catch: java.lang.Throwable -> L85
        ...
        L59:
            int r10 = f.j.S0     // Catch: java.lang.Throwable -> L85
            boolean r11 = r0.s(r10)     // Catch: java.lang.Throwable -> L85
            if (r11 == 0) goto L6a
            android.widget.CheckedTextView r11 = r9.f1170a     // Catch: java.lang.Throwable -> L85
        ...
        L6a:
            int r10 = f.j.T0     // Catch: java.lang.Throwable -> L85
            boolean r11 = r0.s(r10)     // Catch: java.lang.Throwable -> L85
            if (r11 == 0) goto L81
            android.widget.CheckedTextView r11 = r9.f1170a     // Catch: java.lang.Throwable -> L85
            r1 = -1
