...
public class p1 extends x0 {
    ...
    private final WeakReference f1288b;

    public p1(Context context, Resources resources) {
        super(resources);
        this.f1288b = new WeakReference(context);
    }
    ...
    public Drawable getDrawable(int i10) {
        Context context = (Context) this.f1288b.get();
        return context != null ? w0.h().t(context, this, i10) : a(i10);
    }
