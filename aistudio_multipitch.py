...
for i in range(numFrames):
    ...
    for h in range(2, numHarmonics + 1):
        downsampled_indices = np.arange(0, len(P1), h, dtype=int)  # Use np.arange and dtype=int
        hps_spectrum = hps_spectrum[:len(downsampled_indices)] * P1[downsampled_indices]  # Truncate
