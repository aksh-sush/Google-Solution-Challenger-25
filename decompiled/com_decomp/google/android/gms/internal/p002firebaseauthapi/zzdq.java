...
final class zzdq implements zzki {
    ...
    public final zzdr zzb(byte[] bArr) {
        if (bArr.length == this.zzb) {
            Class<zzag> cls = zzag.class;
            if (this.zza.equals(zzbp.zzb)) {
                zzft zzb2 = zzfu.zzb();
                zzb2.zzj(this.zzc);
                zzb2.zza(zzyu.zzo(bArr, 0, this.zzb));
                return new zzdr((zzag) zzbn.zzh(this.zza, (zzfu) zzb2.zzk(), cls));
                ...
                return new zzdr((zzag) zzbn.zzh(this.zza, (zzew) zzb5.zzk(), cls));
