        ...
        if ((i10 | i11 | ((length - i10) - i11)) >= 0) {
            ...
            while (r11 < i13) {
                ...
                if (zzack.zzd(b11)) {
                    ...
                    if (i15 < i13) {
                        zzack.zzb(b11, bArr[i15], cArr, i12);
                        r11 = i15 + 1;
                        i12++;
                    } else {
                        throw zzaae.zzd();
                    ...
                    if (i15 < i13 - 1) {
                        int i17 = i15 + 1;
                        zzack.zzc(b11, bArr[i15], bArr[i17], cArr, i12);
                        r11 = i17 + 1;
                        i12++;
                    } else {
                        throw zzaae.zzd();
                    ...
                    int i18 = i15 + 1;
                    int i19 = i18 + 1;
                    zzack.zza(b11, bArr[i15], bArr[i18], bArr[i19], cArr, i12);
                    i12 += 2;
                    r11 = i19 + 1;
                } else {
                    throw zzaae.zzd();
