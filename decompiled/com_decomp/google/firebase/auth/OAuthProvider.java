...
public class OAuthProvider extends FederatedAuthProvider {
    ...
    public static class Builder {
        ...
        /* synthetic */ Builder(String str, FirebaseAuth firebaseAuth, b bVar) {
        ...
        public OAuthProvider build() {
            return new OAuthProvider(this.zza, (b) null);
        }
    ...
    public static class CredentialBuilder {
        ...
        /* synthetic */ CredentialBuilder(String str, b bVar) {
            this.zza = str;
        }
    ...
    /* synthetic */ OAuthProvider(Bundle bundle, b bVar) {
        this.zza = bundle;
    }
    ...
    public static CredentialBuilder newCredentialBuilder(String str) {
        return new CredentialBuilder(s.g(str), (b) null);
    }
    ...
    public static Builder newBuilder(String str, FirebaseAuth firebaseAuth) {
        ...
        if (!"facebook.com".equals(str) || zzvr.zzg(firebaseAuth.getApp())) {
            return new Builder(str, firebaseAuth, (b) null);
        }
